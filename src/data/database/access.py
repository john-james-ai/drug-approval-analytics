...
# Modified : Monday, July 19th 2021, 5:32:45 pm                                #
...
class DBDao:
    def __init__(self, dbname):                
        ...
        logger.info("Connected to {}".format(dbname))        
    ...
    def create(self, table, data):
        ...
        sql_query = "INSERT INTO %s ( %s ) VALUES ( %s )" % (table, columns, values_placeholders)
    ...
    def read(self, table, id_col, id_value):
        ...
        sql_query = "SELECT * FROM {table} WHERE {col} = '%s'".format(table=table, col=id_col) % (id_value)        
    ...
    def _get_columns_and_metadata(self, table, schema=None):
        ...
        """        
        if schema:
            sql_query = sql.SQL("SELECT column_name FROM INFORMATION_SCHEMA.COLUMNS WHERE {}.table_name = %s".format(schema))    
        else:
