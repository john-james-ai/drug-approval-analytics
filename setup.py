...
setup(
    ...
    description='AI-Based Clinical Drug Development Approval Decision Support',  # Optional
    ...
    # project.
    author='John James',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='john.james@nov8.ai',  # Optional
    ...
    # larger catalog.
    keywords='Drug Development, Machine Learning, Deep Learning, Clinical Trials, Healthcare',  # Optional
    ...
    install_requires=['pandas, sklearn', 'psycopg2', 'click', 'requests'],  # Optional
